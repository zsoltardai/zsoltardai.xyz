export default function Success({ width = 40, height = 40, color = '#000000' }) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" style={{ backgroundColor: '#43ff6400' }} height={height + 'px'} width={width + 'px'}>
            <g transform="translate(0,-1036.3622)">
                ...
                <path
                    ...
                    style={{ fill: '#27ae60', fillOpacity: 1, stroke: 'none' }}></path>
                <path d="m 13,1044.3622 -3,3 -1,-1 -1,1 1,1 1,1 4,-4 -1,-1 z"
                      style={{ fill: '#ffffff', fillOpacity: 1, fillRule: 'evenodd', stroke: 'none', strokeWidth: '1px', strokeLinecap: 'butt', strokeLinejoin: 'miter', strokeOpacity: 1 }}></path>
            </g>
        </svg>
    );
}