export default function Css({ height = 40, width = 40, color = '#000000' }) {
    return (
        <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" height={height + 'px'} width={width + 'px'} fill={color}>
            <title>CSS3</title>
