export default function Eye({size = 24, color = "var(--text-color)", ...props}) {
  return (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" height={size} width={size} {...props}>
        ...
        <g transform="translate(-421.71429,-531.79074)">
          <g transform="matrix(0.75,0,0,0.74999813,421.46429,-241.22897)">
            <path style={{fill: color, fillOpacity: 1, stroke: 'none'}}
                  ...
                  transform="matrix(1.3333333,0,0,1.3333367,0.33333333,1030.6955)" className="ColorScheme-Text"
                  id="rect4170"></path>
          </g>
        </g>
      </svg>
